...
class DisperseMlp(Model):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.in_keys = [('agents', 'observation', 'agent_pos'), ('agents', 'observation', 'agent_vel'),
                        ('agents', 'observation', 'relative_landmark_pos')]
    ...
    def _forward(self, tensordict: TensorDictBase) -> TensorDictBase:
        ...
        self.in_keys = [('agents', 'observation', 'agent_pos'), ('agents', 'observation', 'agent_vel'),('agents', 'observation', 'relative_landmark_pos')]
...
@dataclass
class DisperseMlpConfig(ModelConfig):
